...
client.on('ready', () => {
    ...
    console.log(`----------------`);
  client.user.setGame(` --help | --bot `,"https://twitch.tv/")
...
client.on('guildMemberAdd', Sal => { 
    ...
    .setImage('https://cdn.discordapp.com/attachments/492309225217720341/495325744168173568/51cIQM-Wn1L._SL210_QL95_BG0000_FMpng_.png') 
    .setTitle('عضو جديد!')
...
3 -  | --help   | To See This Menu

4 -  | --bc     | To Send Message To all Member

5 -  | --ping   | To Know Bot Ping

6 -  | --clear  | To Clear Chat   

7 -  | --bot    | To Know The Bot How Many Server Invited

8 -  | --ban    | To ban Player From The Server

9 -  | --kick   | To kick Player From The Server

10 - | --avatar   | To Know Your Avatar

11 - | New Welcome And Leave System | Create Text Room And Set Name To : Console , And Another One And Set Name to : welcome
**`);
